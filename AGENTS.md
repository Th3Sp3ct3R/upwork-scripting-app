...
**All 59 OpenClaw skills consolidated in one place:**
- Location: `/Users/growthgod/.openclaw/workspace/skills/`
- Index: `SKILLS_INDEX.md` (manifest of all available skills)
- To use a skill: Read its `SKILL.md` in the skill directory

Keep local environment notes in `TOOLS.md` (camera names, SSH details, voice preferences).
